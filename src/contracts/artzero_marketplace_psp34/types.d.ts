...
export type ArtzeroProjectImplsMarketplaceDataBidInformation = {
  bidder: AccountId32;
  bidDate: bigint;
  bidValue: bigint;
};
...
export type ArtzeroProjectError =
  ...
  | {
      ...
      value: OpenbrushContractsErrorsAccessControlAccessControlError;
    }
...
export type OpenbrushContractsErrorsOwnableOwnableError =
  | "CallerIsNotOwner"
  | "NewOwnerIsZero";

export type OpenbrushContractsErrorsAccessControlAccessControlError =
  | "InvalidCaller"
  | "MissingRole"
  | "RoleRedundant";
...
export type ArtzeroProjectImplsMarketplaceDataForSaleItem = {
  nftOwner: AccountId32;
  listedDate: bigint;
  price: bigint;
  isForSale: boolean;
...
export type OpenbrushContractsErrorsPsp34Psp34ReceiverError = {
